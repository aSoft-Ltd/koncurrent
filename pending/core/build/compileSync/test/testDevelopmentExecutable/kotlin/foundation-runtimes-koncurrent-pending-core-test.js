(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib-js-ir.js', './foundation-runtimes-expect-core.js', './foundation-runtimes-koncurrent-primitives-mock.js', './kotlin-kotlin-test-js-ir.js', './kotlinx.coroutines-kotlinx-coroutines-test-js-ir.js', './foundation-runtimes-koncurrent-primitives-coroutines.js', './kotlinx.coroutines-kotlinx-coroutines-core-js-ir.js', './foundation-runtimes-koncurrent-pending-coroutines.js', './foundation-runtimes-koncurrent-primitives-core.js', './foundation-runtimes-functions.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib-js-ir.js'), require('./foundation-runtimes-expect-core.js'), require('./foundation-runtimes-koncurrent-primitives-mock.js'), require('./kotlin-kotlin-test-js-ir.js'), require('./kotlinx.coroutines-kotlinx-coroutines-test-js-ir.js'), require('./foundation-runtimes-koncurrent-primitives-coroutines.js'), require('./kotlinx.coroutines-kotlinx-coroutines-core-js-ir.js'), require('./foundation-runtimes-koncurrent-pending-coroutines.js'), require('./foundation-runtimes-koncurrent-primitives-core.js'), require('./foundation-runtimes-functions.js'));
  else {
    if (typeof this['kotlin-kotlin-stdlib-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'kotlin-kotlin-stdlib-js-ir' was not found. Please, check whether 'kotlin-kotlin-stdlib-js-ir' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['foundation-runtimes-expect-core'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'foundation-runtimes-expect-core' was not found. Please, check whether 'foundation-runtimes-expect-core' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['foundation-runtimes-koncurrent-primitives-mock'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'foundation-runtimes-koncurrent-primitives-mock' was not found. Please, check whether 'foundation-runtimes-koncurrent-primitives-mock' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['kotlin-kotlin-test-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'kotlin-kotlin-test-js-ir' was not found. Please, check whether 'kotlin-kotlin-test-js-ir' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['kotlinx.coroutines-kotlinx-coroutines-test-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'kotlinx.coroutines-kotlinx-coroutines-test-js-ir' was not found. Please, check whether 'kotlinx.coroutines-kotlinx-coroutines-test-js-ir' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['foundation-runtimes-koncurrent-primitives-coroutines'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'foundation-runtimes-koncurrent-primitives-coroutines' was not found. Please, check whether 'foundation-runtimes-koncurrent-primitives-coroutines' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['kotlinx.coroutines-kotlinx-coroutines-core-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'kotlinx.coroutines-kotlinx-coroutines-core-js-ir' was not found. Please, check whether 'kotlinx.coroutines-kotlinx-coroutines-core-js-ir' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['foundation-runtimes-koncurrent-pending-coroutines'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'foundation-runtimes-koncurrent-pending-coroutines' was not found. Please, check whether 'foundation-runtimes-koncurrent-pending-coroutines' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['foundation-runtimes-koncurrent-primitives-core'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'foundation-runtimes-koncurrent-primitives-core' was not found. Please, check whether 'foundation-runtimes-koncurrent-primitives-core' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    if (typeof this['foundation-runtimes-functions'] === 'undefined') {
      throw new Error("Error loading module 'foundation-runtimes-koncurrent-pending-core-test'. Its dependency 'foundation-runtimes-functions' was not found. Please, check whether 'foundation-runtimes-functions' is loaded prior to 'foundation-runtimes-koncurrent-pending-core-test'.");
    }
    root['foundation-runtimes-koncurrent-pending-core-test'] = factory(typeof this['foundation-runtimes-koncurrent-pending-core-test'] === 'undefined' ? {} : this['foundation-runtimes-koncurrent-pending-core-test'], this['kotlin-kotlin-stdlib-js-ir'], this['foundation-runtimes-expect-core'], this['foundation-runtimes-koncurrent-primitives-mock'], this['kotlin-kotlin-test-js-ir'], this['kotlinx.coroutines-kotlinx-coroutines-test-js-ir'], this['foundation-runtimes-koncurrent-primitives-coroutines'], this['kotlinx.coroutines-kotlinx-coroutines-core-js-ir'], this['foundation-runtimes-koncurrent-pending-coroutines'], this['foundation-runtimes-koncurrent-primitives-core'], this['foundation-runtimes-functions']);
  }
}(this, function (_, kotlin_kotlin, kotlin_foundation_runtimes_expect_core, kotlin_foundation_runtimes_koncurrent_primitives_mock, kotlin_kotlin_test, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_test, kotlin_foundation_runtimes_koncurrent_primitives_coroutines, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core, kotlin_foundation_runtimes_koncurrent_pending_coroutines, kotlin_foundation_runtimes_koncurrent_primitives_core, kotlin_foundation_runtimes_functions) {
  'use strict';
  //region block: imports
  var imul = Math.imul;
  var Unit_getInstance = kotlin_kotlin.$_$.h1;
  var expect = kotlin_foundation_runtimes_expect_core.$_$.a;
  var println = kotlin_kotlin.$_$.q2;
  var RuntimeException_init_$Create$ = kotlin_kotlin.$_$.t;
  var throwKotlinNothingValueException = kotlin_kotlin.$_$.h4;
  ...
  var CoroutineImpl = kotlin_kotlin.$_$.l2;
  var TestScope = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_test.$_$.b;
  var isInterface = kotlin_kotlin.$_$.c3;
  ...
  var SuspendFunction1 = kotlin_kotlin.$_$.n2;
  ...
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype = Object.create(CoroutineImpl.prototype);
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype.constructor = NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda;
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype = Object.create(CoroutineImpl.prototype);
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype.constructor = NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda;
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype = Object.create(CoroutineImpl.prototype);
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype.constructor = NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda;
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype = Object.create(CoroutineImpl.prototype);
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype.constructor = NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda;
  ...
  //endregion
  function CanConstructAFunctioningPending$should_resolve_quickly$lambda() {
    return function () {
      return 42;
    };
  }
  function CanConstructAFunctioningPending$should_resolve_quickly$lambda_0($tmp1_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
        tmp = resolve($tmp1_pending());
      } catch ($p) {
        var tmp_0;
  ...
  function CanConstructAFunctioningPending$should_resolve_quickly$lambda_1() {
    return function (it) {
      expect(it).toBe_vfaz1p_k$(42);
      println('Got ' + it);
      return Unit_getInstance();
    };
  }
  function CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda() {
    return function () {
      throw RuntimeException_init_$Create$('Wooozaaaaa');
    };
  }
  function CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda_0($tmp1_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
        $tmp1_pending();
        tmp = resolve(throwKotlinNothingValueException());
      } catch ($p) {
        var tmp_0;
        if ($p instanceof Error) {
          tmp_0 = reject($p);
  ...
  function CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda_1() {
    return function (it) {
      println('Recovering from ' + it.message);
      return 43;
    };
  }
  function CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda_2() {
    return function (it) {
      println('Adding the pending object');
      expect(it).toBe_vfaz1p_k$(43);
      return it + 1 | 0;
    };
  }
  function CanConstructAFunctioningPending() {
    var tmp = this;
    tmp.executor_1 = MockExecutor_init_$Create$(null, 1, null);
  }
  CanConstructAFunctioningPending.prototype.get_executor_1zf7oc_k$ = function () {
    return this.executor_1;
  };
  CanConstructAFunctioningPending.prototype.should_resolve_quickly_usp79m_k$ = function () {
    var tmp$ret$0;
    {
      var tmp0_pending = this.executor_1;
      var tmp1_pending = CanConstructAFunctioningPending$should_resolve_quickly$lambda();
      tmp$ret$0 = new Promise(CanConstructAFunctioningPending$should_resolve_quickly$lambda_0(tmp1_pending));
    }
    var p = tmp$ret$0;
    var tmp$ret$1;
    {
      var tmp2_then = this.executor_1;
      var tmp3_then = CanConstructAFunctioningPending$should_resolve_quickly$lambda_1();
      tmp$ret$1 = p.then(tmp3_then);
    }
  };
  CanConstructAFunctioningPending.prototype.should_be_able_to_recover_on_a_failure_r3ptbv_k$ = function () {
    var tmp$ret$0;
    {
      var tmp0_pending = this.executor_1;
      var tmp1_pending = CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda();
      tmp$ret$0 = new Promise(CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda_0(tmp1_pending));
    }
    var p = tmp$ret$0;
    var tmp$ret$3;
    {
      var tmp$ret$2;
      {
        var tmp2_catch = this.executor_1;
        var tmp3_catch = CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda_1();
        var tmp$ret$1;
        {
          tmp$ret$1 = (p instanceof Promise ? p : THROW_CCE()).catch(tmp3_catch);
        }
        tmp$ret$2 = tmp$ret$1;
      }
      var tmp4_then = tmp$ret$2;
      var tmp5_then = this.executor_1;
      var tmp6_then = CanConstructAFunctioningPending$should_be_able_to_recover_on_a_failure$lambda_2();
      tmp$ret$3 = tmp4_then.then(tmp6_then);
    }
  };
  CanConstructAFunctioningPending.$metadata$ = classMeta('CanConstructAFunctioningPending');
  function test_fun_izoufj() {
    suite('CanConstructAFunctioningPending', false, test_fun$CanConstructAFunctioningPending_test_fun_9pw1nh());
  }
  function test_fun$CanConstructAFunctioningPending_test_fun$should_resolve_quickly_test_fun_kypwb3() {
    return function () {
      var tmp = new CanConstructAFunctioningPending();
      tmp.should_resolve_quickly_usp79m_k$();
      return Unit_getInstance();
      $unreachable();
    };
  }
  function test_fun$CanConstructAFunctioningPending_test_fun$should_be_able_to_recover_on_a_failure_test_fun_hqz4ek() {
    return function () {
      var tmp = new CanConstructAFunctioningPending();
      tmp.should_be_able_to_recover_on_a_failure_r3ptbv_k$();
      return Unit_getInstance();
      $unreachable();
    };
  }
  function test_fun$CanConstructAFunctioningPending_test_fun_9pw1nh() {
    return function () {
      test('should_resolve_quickly', false, test_fun$CanConstructAFunctioningPending_test_fun$should_resolve_quickly_test_fun_kypwb3());
      test('should_be_able_to_recover_on_a_failure', false, test_fun$CanConstructAFunctioningPending_test_fun$should_be_able_to_recover_on_a_failure_test_fun_hqz4ek());
      return Unit_getInstance();
    };
  }
  ...
  function CoroutinesCanAwait$should_be_able_to_await_a_coroutine$lambda_0($tmp1_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
        tmp = resolve($tmp1_pending());
  ...
  function CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$lambda_0($tmp1_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
        tmp = resolve($tmp1_pending());
  ...
  function CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda_0($tmp1_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
        tmp = resolve($tmp1_pending());
  ...
  function CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda_0($tmp1_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
        tmp = resolve($tmp1_pending());
  ...
  CoroutinesCanAwait.prototype.get_executor_1zf7oc_k$ = function () {
    return this.executor_1;
  };
  CoroutinesCanAwait.prototype.should_be_able_to_await_a_coroutine_gu2dcy_k$ = function () {
    ...
    {
      var tmp0_pending = this.executor_1;
      var tmp1_pending = CoroutinesCanAwait$should_be_able_to_await_a_coroutine$lambda();
      tmp$ret$0 = new Promise(CoroutinesCanAwait$should_be_able_to_await_a_coroutine$lambda_0(tmp1_pending));
    }
    ...
    var tmp$ret$3;
    {
      var tmp$ret$2;
      {
        var tmp$ret$1;
        {
          ...
          {
            var tmp0_pending = this.executor_1;
            var tmp1_pending = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$lambda();
            tmp$ret$0 = new Promise(CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$lambda_0(tmp1_pending));
          }
          var tmp2_catch = tmp$ret$0;
          var tmp3_catch = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$lambda_1();
          tmp$ret$1 = (tmp2_catch instanceof Promise ? tmp2_catch : THROW_CCE()).catch(tmp3_catch);
        }
        var tmp4_then = tmp$ret$1;
        var tmp5_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$lambda_2();
        tmp$ret$2 = tmp4_then.then(tmp5_then);
      }
      var tmp6_then = tmp$ret$2;
      var tmp7_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$lambda_3();
      tmp$ret$3 = tmp6_then.then(tmp7_then);
    }
    var result = tmp$ret$3;
    var tmp = new Long(0, 0);
    return runTest$default(null, tmp, CoroutinesCanAwait$should_be_able_to_recover_from_an_error_at_the_start_of_a_pipeline$slambda_0(result, null), 3, null);
  };
      ...
      var tmp$ret$3;
      {
        var tmp$ret$2;
        {
          var tmp$ret$1;
          {
            ...
            {
              var tmp0_pending = this.executor_1;
              var tmp1_pending = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda();
              tmp$ret$0 = new Promise(CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda_0(tmp1_pending));
            }
            var tmp2_then = tmp$ret$0;
            var tmp3_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda_1();
            tmp$ret$1 = tmp2_then.then(tmp3_then);
          }
          var tmp4_catch = tmp$ret$1;
          var tmp5_catch = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda_2();
          tmp$ret$2 = (tmp4_catch instanceof Promise ? tmp4_catch : THROW_CCE()).catch(tmp5_catch);
        }
        var tmp6_then = tmp$ret$2;
        var tmp7_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda_3();
        tmp$ret$3 = tmp6_then.then(tmp7_then);
      }
      var tmp8_then = tmp$ret$3;
      var tmp9_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline_with_rejected_operations_in_between_pipeline$lambda_4();
      tmp$ret$4 = tmp8_then.then(tmp9_then);
    }
      ...
      var tmp$ret$3;
      {
        var tmp$ret$2;
        {
          var tmp$ret$1;
          {
            ...
            {
              var tmp0_pending = this.executor_1;
              var tmp1_pending = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda(zero);
              tmp$ret$0 = new Promise(CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda_0(tmp1_pending));
            }
            var tmp2_then = tmp$ret$0;
            var tmp3_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda_1(zero);
            tmp$ret$1 = tmp2_then.then(tmp3_then);
          }
          var tmp4_then = tmp$ret$1;
          var tmp5_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda_2();
          tmp$ret$2 = tmp4_then.then(tmp5_then);
        }
        var tmp6_catch = tmp$ret$2;
        var tmp7_catch = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda_3(zero);
        tmp$ret$3 = (tmp6_catch instanceof Promise ? tmp6_catch : THROW_CCE()).catch(tmp7_catch);
      }
      var tmp8_then = tmp$ret$3;
      var tmp9_then = CoroutinesCanAwait$should_be_able_to_recover_from_an_error_mid_pipeline$lambda_4();
      tmp$ret$4 = tmp8_then.then(tmp9_then);
    }
    var result = tmp$ret$4;
    var tmp = new Long(0, 0);
  ...
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda(resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
  }
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype.invoke_u7fh2j_k$ = function ($this$pending, $cont) {
    var tmp = this.create_b6qu53_k$($this$pending, $cont);
    tmp.result_1 = Unit_getInstance();
    tmp.exception_1 = null;
    return tmp.doResume_5yljmg_k$();
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype.invoke_5zdxxo_k$ = function (p1, $cont) {
    return this.invoke_u7fh2j_k$((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $cont);
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype.doResume_5yljmg_k$ = function () {
    var suspendResult = this.result_1;
    $sm: do
      try {
        var tmp = this.state_1;
  ...
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype.create_b6qu53_k$ = function ($this$pending, completion) {
    var i = new NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda(completion);
    i.$this$pending_1 = $this$pending;
    return i;
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.prototype.create_xubfvz_k$ = function (value, completion) {
    return this.create_b6qu53_k$((!(value == null) ? isInterface(value, CoroutineScope) : false) ? value : THROW_CCE(), completion);
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda.$metadata$ = classMeta('NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda', undefined, undefined, undefined, [1], CoroutineImpl.prototype);
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda_0(resultContinuation) {
    var i = new NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda(resultContinuation);
  ...
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda($it, resultContinuation) {
    this.$it_1 = $it;
    CoroutineImpl.call(this, resultContinuation);
  }
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype.invoke_u7fh2j_k$ = function ($this$pending, $cont) {
    var tmp = this.create_b6qu53_k$($this$pending, $cont);
    tmp.result_1 = Unit_getInstance();
    tmp.exception_1 = null;
    return tmp.doResume_5yljmg_k$();
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype.invoke_5zdxxo_k$ = function (p1, $cont) {
    return this.invoke_u7fh2j_k$((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $cont);
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype.doResume_5yljmg_k$ = function () {
    var suspendResult = this.result_1;
    $sm: do
      try {
        var tmp = this.state_1;
  ...
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype.create_b6qu53_k$ = function ($this$pending, completion) {
    var i = new NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda(this.$it_1, completion);
    i.$this$pending_1 = $this$pending;
    return i;
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.prototype.create_xubfvz_k$ = function (value, completion) {
    return this.create_b6qu53_k$((!(value == null) ? isInterface(value, CoroutineScope) : false) ? value : THROW_CCE(), completion);
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda.$metadata$ = classMeta('NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda', undefined, undefined, undefined, [1], CoroutineImpl.prototype);
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda_0($it, resultContinuation) {
    var i = new NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda($it, resultContinuation);
    var l = function ($this$pending, $cont) {
      return i.invoke_u7fh2j_k$($this$pending, $cont);
    };
    l.$arity = 1;
  ...
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda($this_runTest) {
    return function (it) {
      return pending$default($this_runTest, null, null, NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda$slambda_0(it, null), 3, null);
    };
  }
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda(resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
  }
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype.invoke_qflhgo_k$ = function ($this$runTest, $cont) {
    var tmp = this.create_5ibv4j_k$($this$runTest, $cont);
    tmp.result_1 = Unit_getInstance();
    tmp.exception_1 = null;
    return tmp.doResume_5yljmg_k$();
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype.invoke_5zdxxo_k$ = function (p1, $cont) {
    return this.invoke_qflhgo_k$((!(p1 == null) ? isInterface(p1, TestScope) : false) ? p1 : THROW_CCE(), $cont);
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype.doResume_5yljmg_k$ = function () {
    var suspendResult = this.result_1;
    $sm: do
      try {
        var tmp = this.state_1;
        switch (tmp) {
          case 0:
            ...
            var tmp_0 = this;
            var tmp_1 = this;
            tmp_1.tmp0_flatten0__1 = pending$default(this.$this$runTest_1, null, null, NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$slambda_0(null), 3, null);
            var tmp_2 = this;
            tmp_2.tmp1_flatten1__1 = NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda$lambda(this.$this$runTest_1);
            var tmp_3 = this;
            tmp_3.tmp0_unsafeCast2__1 = this.tmp0_flatten0__1.then(this.tmp1_flatten1__1);
            tmp_0.p3__1 = this.tmp0_unsafeCast2__1;
            this.state_1 = 1;
            suspendResult = await_0(this.p3__1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype.create_5ibv4j_k$ = function ($this$runTest, completion) {
    var i = new NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda(completion);
    i.$this$runTest_1 = $this$runTest;
    return i;
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.prototype.create_xubfvz_k$ = function (value, completion) {
    return this.create_5ibv4j_k$((!(value == null) ? isInterface(value, TestScope) : false) ? value : THROW_CCE(), completion);
  };
  NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda.$metadata$ = classMeta('NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda', undefined, undefined, undefined, [1], CoroutineImpl.prototype);
  function NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda_0(resultContinuation) {
    var i = new NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda(resultContinuation);
    var l = function ($this$runTest, $cont) {
      return i.invoke_qflhgo_k$($this$runTest, $cont);
    };
    l.$arity = 1;
  ...
  function NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda(resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
  }
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype.invoke_qflhgo_k$ = function ($this$runTest, $cont) {
    var tmp = this.create_5ibv4j_k$($this$runTest, $cont);
    tmp.result_1 = Unit_getInstance();
    tmp.exception_1 = null;
    return tmp.doResume_5yljmg_k$();
  };
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype.invoke_5zdxxo_k$ = function (p1, $cont) {
    return this.invoke_qflhgo_k$((!(p1 == null) ? isInterface(p1, TestScope) : false) ? p1 : THROW_CCE(), $cont);
  };
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype.doResume_5yljmg_k$ = function () {
    var suspendResult = this.result_1;
    $sm: do
      try {
        var tmp = this.state_1;
        switch (tmp) {
          case 0:
            ...
            var tmp_0 = this;
            var tmp_1 = this;
            tmp_1.tmp0_ResolvedPending0__1 = Promise.resolve(2);
            tmp_0.p1__1 = Promise.resolve(this.tmp0_ResolvedPending0__1);
            this.state_1 = 1;
            suspendResult = await_0(this.p1__1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype.create_5ibv4j_k$ = function ($this$runTest, completion) {
    var i = new NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda(completion);
    i.$this$runTest_1 = $this$runTest;
    return i;
  };
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.prototype.create_xubfvz_k$ = function (value, completion) {
    return this.create_5ibv4j_k$((!(value == null) ? isInterface(value, TestScope) : false) ? value : THROW_CCE(), completion);
  };
  NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda.$metadata$ = classMeta('NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda', undefined, undefined, undefined, [1], CoroutineImpl.prototype);
  function NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda_0(resultContinuation) {
    var i = new NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda(resultContinuation);
    var l = function ($this$runTest, $cont) {
      return i.invoke_qflhgo_k$($this$runTest, $cont);
    };
    l.$arity = 1;
  ...
  function NestedPendingValuesTest() {
  }
  NestedPendingValuesTest.prototype.should_be_able_to_unwrap_nested_values_with_the_unwrap_method_tglqoo_k$ = function () {
    var tmp = new Long(0, 0);
    return runTest$default(null, tmp, NestedPendingValuesTest$should_be_able_to_unwrap_nested_values_with_the_unwrap_method$slambda_0(null), 3, null);
  };
  NestedPendingValuesTest.prototype.should_be_able_to_await_nested_values_ro4z5a_k$ = function () {
    var tmp = new Long(0, 0);
    return runTest$default(null, tmp, NestedPendingValuesTest$should_be_able_to_await_nested_values$slambda_0(null), 3, null);
  };
  NestedPendingValuesTest.$metadata$ = classMeta('NestedPendingValuesTest');
  function test_fun_izoufj_1() {
    suite('NestedPendingValuesTest', false, test_fun$NestedPendingValuesTest_test_fun_5l6ky8());
  }
  function test_fun$NestedPendingValuesTest_test_fun$should_be_able_to_unwrap_nested_values_with_the_unwrap_method_test_fun_dvkas3() {
    return function () {
      var tmp = new NestedPendingValuesTest();
      return tmp.should_be_able_to_unwrap_nested_values_with_the_unwrap_method_tglqoo_k$();
      $unreachable();
    };
  }
  function test_fun$NestedPendingValuesTest_test_fun$should_be_able_to_await_nested_values_test_fun_1yp53h() {
    return function () {
      var tmp = new NestedPendingValuesTest();
      return tmp.should_be_able_to_await_nested_values_ro4z5a_k$();
      $unreachable();
    };
  }
  function test_fun$NestedPendingValuesTest_test_fun_5l6ky8() {
    return function () {
      test('should_be_able_to_unwrap_nested_values_with_the_unwrap_method', false, test_fun$NestedPendingValuesTest_test_fun$should_be_able_to_unwrap_nested_values_with_the_unwrap_method_test_fun_dvkas3());
      test('should_be_able_to_await_nested_values', false, test_fun$NestedPendingValuesTest_test_fun$should_be_able_to_await_nested_values_test_fun_1yp53h());
      return Unit_getInstance();
    };
  }
  ...
  function PendingsCanRunToTheEnd$should_run_to_completion$lambda() {
    return function () {
      throw RuntimeException_init_$Create$('Wooozaaaaa');
    };
  }
  function PendingsCanRunToTheEnd$should_run_to_completion$lambda_0($tmp0_pending) {
    return function (resolve, reject) {
      var tmp;
      try {
  ...
  function PendingsCanRunToTheEnd$should_run_to_completion$lambda_1() {
    return function (it) {
      println('Recovering from ' + it.message);
      return 43;
    };
  }
  function PendingsCanRunToTheEnd$should_run_to_completion$lambda_2() {
    return function (it) {
      println('Adding the pending object');
      return it + 1 | 0;
    };
  }
  function PendingsCanRunToTheEnd$should_run_to_completion$lambda_3() {
    return function (it) {
      println('trying to return unit');
      return Unit_getInstance();
    };
  }
  function PendingsCanRunToTheEnd$should_run_to_completion$lambda_4() {
    return function () {
      println('completed');
      return Unit_getInstance();
    };
  }
  function PendingsCanRunToTheEnd() {
  }
  PendingsCanRunToTheEnd.prototype.should_run_to_completion_tkvoio_k$ = function () {
    var tmp$ret$2;
    {
      var tmp$ret$1;
      {
        var tmp$ret$0;
        {
          var tmp0_pending = PendingsCanRunToTheEnd$should_run_to_completion$lambda();
          tmp$ret$0 = new Promise(PendingsCanRunToTheEnd$should_run_to_completion$lambda_0(tmp0_pending));
        }
        var tmp = tmp$ret$0;
        var tmp_0 = tmp instanceof Promise ? tmp : THROW_CCE();
        var tmp1_then = tmp_0.catch(PendingsCanRunToTheEnd$should_run_to_completion$lambda_1());
        var tmp2_then = PendingsCanRunToTheEnd$should_run_to_completion$lambda_2();
        tmp$ret$1 = tmp1_then.then(tmp2_then);
      }
      var tmp3_then = tmp$ret$1;
      var tmp4_then = PendingsCanRunToTheEnd$should_run_to_completion$lambda_3();
      tmp$ret$2 = tmp3_then.then(tmp4_then);
    }
    var tmp_1 = tmp$ret$2;
    return tmp_1.finally(PendingsCanRunToTheEnd$should_run_to_completion$lambda_4());
  };
  PendingsCanRunToTheEnd.$metadata$ = classMeta('PendingsCanRunToTheEnd');
  function test_fun_izoufj_4() {
    suite('PendingsCanRunToTheEnd', false, test_fun$PendingsCanRunToTheEnd_test_fun_ea5m3m());
  }
  function test_fun$PendingsCanRunToTheEnd_test_fun$should_run_to_completion_test_fun_pg4o9d() {
    return function () {
      var tmp = new PendingsCanRunToTheEnd();
      return tmp.should_run_to_completion_tkvoio_k$();
      $unreachable();
    };
  }
  function test_fun$PendingsCanRunToTheEnd_test_fun_ea5m3m() {
    return function () {
      test('should_run_to_completion', false, test_fun$PendingsCanRunToTheEnd_test_fun$should_run_to_completion_test_fun_pg4o9d());
      return Unit_getInstance();
    };
  }
  //region block: tests
...
//# sourceMappingURL=foundation-runtimes-koncurrent-pending-core-test.js.map